...
@import url("https://fonts.googleapis.com/css2?family=Fredoka:wght@400;500;600;700&display=swap");
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .power-card .value { font-family: 'Fredoka', sans-serif; font-size: 22px; font-weight: 800; }
  ...
  .squad-summary h4 { font-family: 'Fredoka', sans-serif; color: var(--dark); margin-bottom: 6px; }
  ...
  .recommendations h4 { font-family: 'Fredoka', sans-serif; color: var(--dark); margin-bottom: 8px; }
  .rec-item {
  ...
  .plan-info-box h4 { font-family: 'Fredoka', sans-serif; color: var(--dark); margin-bottom: 8px; font-size: 14px; }
  ...
  .plan-summary h4 { font-family: 'Fredoka', sans-serif; color: var(--dark); margin-bottom: 6px; }
